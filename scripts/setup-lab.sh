...
echo "  Gateway Simulation: Operation First Contact"
echo "  Initialising Forward Observation Post..."
echo "=============================================="
echo ""
...
echo "  Building forward observation post nodes..."
...
for node in sdc-fwd-web:2231 sdc-fwd-db:2232 sdc-fwd-comms:2233; do
    name="${node%%:*}"
    port="${node##*:}"
...
echo ""
echo "=============================================="
echo "  Forward Observation Post: 3 nodes ONLINE"
echo ""
echo "  WARNING: The Voidborn have compromised this"
echo "  post. All three nodes are exposed. SSH wide"
echo "  open. Firewalls down. Credentials in the"
echo "  clear. Services running that shouldn't be."
echo ""
echo "  You have 75 minutes."
echo ""
...
ARIA_SCORE_TARGETS="sdc-fwd-web=2231 sdc-fwd-db=2232 sdc-fwd-comms=2233" \
